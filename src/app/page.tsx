      ...
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 md:px-8 text-white min-h-screen md:min-h-[1000px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 md:gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-4">
            ...
            <a href="http://localhost:8080" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 text-white font-semibold py-2 px-4 md:py-3 md:px-8 text-sm md:text-base rounded-full border border-white/20 transition-colors backdrop-blur-md">
              Sports
            </a>
